...
public class Lambda03 {
    public static void main(String[] args) {
        List<String> menu = new ArrayList<>(Arrays.asList("küşleme", "adana", "trileçe", "havucDilim", "buryan",
                "yaglama", "kokareç", "arabAşı", "güveç", "trileçe", "welemen", "cacix"));
        alfBykTekrrsz(menu);
        System.out.println("\n   ***   ");
...
public static void wleBaslirMi(List<String> menu){
    System.out.println(menu.
            stream().
            noneMatch(t->t.startsWith("w"))?"Agam w ile baslayan yimag olar mi hec":"agam wenemen ne menem bi sey?");
}

    // Task : List elelmanlarinin "x" ile biten en az bir elemanı kontrol ediniz.
    public static void xleBitirMi(List<String> menu) {
        System.out.println(menu.
                stream().
                anyMatch(t -> t.endsWith("x")) ?
                "Agam x ile biten yimag olar mi hec" :
                "agam cacix ne menem bi sey?");
    }
    // Task : Karakter sayisi en buyuk elemani yazdiriniz.
    public static void enBuyukLength(List<String> menu){
        System.out.println(menu.
                stream().
                sorted(Comparator.comparing(t -> t.toString().length()).reversed()).findFirst());
        System.out.println(menu.
                stream().
    ...
    public static void ilkHaric(List<String> menu){

        menu.
                stream().
                sorted(Comparator.comparing(t->t.charAt(t.length()-1))).
                skip(1). //ilk elemani haric tuttu
                forEach(t-> System.out.println(t+" "));
    }
    public static void ilkiHaric(List<String> menu){

        menu.
                stream().
                sorted(Comparator.comparing(t->t.charAt(t.length()-1))).
                skip(5).//ilk bes elemani haric tuttu
                forEach(t-> System.out.println(t+" "));
    }
